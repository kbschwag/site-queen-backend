...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-pill text-sm font-semibold tracking-tight ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-brand-purple-deep hover:-translate-y-[1px] hover:shadow-md",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-brand-purple bg-transparent text-brand-purple hover:bg-brand-purple-soft",
        secondary:
          "bg-brand-purple-soft text-brand-purple hover:bg-brand-purple-soft/70",
        ghost: "text-brand-purple hover:bg-brand-purple-soft",
        link: "text-brand-purple underline-offset-4 hover:underline",
        gold: "bg-brand-gold text-brand-ink shadow-sm hover:bg-brand-gold-deep hover:-translate-y-[1px]",
      },
      size: {
